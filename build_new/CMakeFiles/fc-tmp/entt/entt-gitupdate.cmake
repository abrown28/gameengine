...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "v3.12.2"
  WORKING_DIRECTORY "E:/APBData/GameEngine/build_new/_deps/entt-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'E:/APBData/GameEngine/build_new/_deps/entt-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'E:/APBData/GameEngine/build_new/_deps/entt-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
